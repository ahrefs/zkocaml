...
(* OASIS_START *)
(* DO NOT EDIT (digest: 18aa39ec1648cfffc34b35a6663cc63b) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test.ml", ["test"]))];
     ...
     package =
       {
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("./test.ml", ["clean_bin"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          ...
          clean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("./test.ml", ["clean"])))]
            };
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\156iO\025\138\1717L\181\127\213@!\201\250\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
